...
contract LiquidityGeneratorTokenFactory is TokenFactoryBase {
  ...
  function create(string memory name, string memory symbol, uint256 totalSupply, address router, address charity,
    uint16 taxFeeBps, uint16 liquidityFeeBps, uint16 charityBps, uint16 maxTxBps)
